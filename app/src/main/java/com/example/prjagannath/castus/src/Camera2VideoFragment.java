...
//
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        mPublisher.setSurfaceView((SurfaceView) view.findViewById(R.id.texture));
        ...
        mPublisher.setPublishEventHandler(new RtmpPublisher.EventHandler() {
            ...
            public void onRtmpConnecting(String msg) {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    @Override
                    public void run() {
                        Toast.makeText(getContext(), mNotifyMsg, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        ...
        Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
            ...
            public void uncaughtException(Thread thread, Throwable ex) {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    @TargetApi(Build.VERSION_CODES.M)
                    public void run() {
                        Toast.makeText(getContext(), mNotifyMsg, Toast.LENGTH_LONG).show();
        ...
        switch (view.getId()) {
            case R.id.video: {
                if (mIsRecordingVideo) {
                    ...
                    startRecordingVideo("rtmp://ossrs.net/1wr/12345");
                }
                break;
            }
            case R.id.front: {
...
//                }
    ...
    private void startRecordingVideo(String rtmpUrl) {
