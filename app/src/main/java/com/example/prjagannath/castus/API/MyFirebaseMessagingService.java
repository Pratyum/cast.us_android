...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotification(String messageTitle, String messageBody) {
        ...
        Intent acceptIntent = new Intent(this, LoginActivity.class);
        acceptIntent.putExtra("notificationID", 0);
        acceptIntent.putExtra("data", messageBody);
        Intent rejectIntent = new Intent(this, NotificationButton.class);
        rejectIntent.putExtra("notificationID", 0);
...
//        rejectIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        PendingIntent pendingAcceptIntent = PendingIntent.getActivity(this, 0 /* Request code */, acceptIntent,
                0);
        PendingIntent pendingRejectIntent = PendingIntent.getBroadcast(this, 0 /* Request code */, rejectIntent,
                0);
        ...
        Notification notifi = new Notification.Builder(this)
                ...
                .setContentText(messageBody.split("|")[0])
                .setAutoCancel(true)
